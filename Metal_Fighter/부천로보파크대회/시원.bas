...
KEY1:
    ...
    MOVE G6D, 118, 167,  36, 120,  81,
    MOVE G6B, 104, 170, 183,  ,  ,
    MOVE G6C, 104, 100,  99,  ,  ,
    WAIT
    MOVE G6A,  76, 160,  27, 127,  85,
    MOVE G6D, 118, 166,  36, 117, 125,
    MOVE G6B, 104, 170, 183,  ,  ,
    MOVE G6C, 104,  99, 103,  ,  ,
    WAIT
    ...
    FOR x=1 TO 2
        MOVE G6A, 102,  83, 144,  95, 188,
        MOVE G6D, 118, 166,  26, 127, 188,
        MOVE G6B, 100, 104, 184,  ,  ,
        MOVE G6C, 100, 178, 183,  ,  ,
        WAIT
        DELAY 500
        MOVE G6A, 102,  83, 144,  95, 188,
        MOVE G6D, 118, 166,  26, 127, 188,
    ...
    'shoking arms wave
    SPEED 8
    MOVE G6A, 101,  76, 144,  94,  100,
    MOVE G6D, 101,  75, 141,  94,  100,
    MOVE G6B, 101,  30,  80,  ,  ,
    MOVE G6C, 101,  31,  81,  ,  ,
    WAIT
    DELAY 500
