...
KEY7: 'X
    'SPEED 12
    '    MOVE G6A,  95,  94, 111, 113, 105,
    '    MOVE G6D,  95,  94, 111, 113, 105,
    '    MOVE G6B, 100,  30,  80,  ,  ,
    '    MOVE G6C, 100,  30,  80,  ,  ,
    '    WAIT
    '    MOVE G6A, 108, 135,  49, 128, 115,
    '    MOVE G6D,  70,  99, 102, 113, 109,
    '    MOVE G6B, 100,  30,  120,  ,  ,
    '    MOVE G6C, 100,  30,  80,  ,  ,
    '    WAIT
    '    SPEED 15
    '    MOVE G6A, 110, 156,  25, 129, 150,
    '    MOVE G6D,  68,  83, 123, 103,  81,
    '    MOVE G6B, 101, 102, 134,  ,  ,
    '    MOVE G6C, 100,  30,  80,  ,  ,
    '    WAIT
    '    MOVE G6A, 108, 135,  49, 128, 115,
    '    MOVE G6D,  70,  99, 102, 113, 109,
    ...
    MOVE G6A,  99,  94, 111, 113, 100,
    MOVE G6D,  99,  94, 111, 113, 100,
    MOVE G6B, 155,  32,  82,  , 40 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    MOVE G6A, 101,  80, 102, 160, 100,
    MOVE G6D, 101,  80, 102, 160, 100,
    MOVE G6B, 163,  32,  82,  ,  ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    ...
    MOVE G6A, 101,  80, 102, 160, 100,
    MOVE G6D, 101,  80, 102, 160, 100,
    MOVE G6B, 165,  32,  82,  , 125 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    MOVE G6A,  99,  94, 111, 113, 100,
    MOVE G6D,  99,  94, 111, 113, 100,
    MOVE G6B, 155,  32,  82,  , 125 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    MOVE G6A, 100,  85 , 118, 112, 100,
    MOVE G6D, 100,  85, 118, 112, 100,
    MOVE G6B, 185,  32,  82,  , 125 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    MOVE G6B, 185,  82,  102,  , 125 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    MOVE G6B, 185,  82,  102,  , 40 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
    MOVE G6B, 100,  82,  102,  , 40 ,
    MOVE G6C, 100,  40,  80,  ,  ,
    WAIT
